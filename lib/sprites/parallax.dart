...
const locations = [
  ...
  Location(
    name: 'Machu Picchu',
    place: 'Peru',
    imageUrl: 'assets/images/fish.gif',
  ),
  Location(
    name: 'Vitznau',
    place: 'Switzerland',
    imageUrl: 'assets/images/hampter.png',
  ),
  Location(
    name: 'Bali',
    place: 'Indonesia',
    imageUrl: 'assets/images/neco.png',
  ),
  Location(
    name: 'Mexico City',
    place: 'Mexico',
    imageUrl: 'assets/images/lecho.png',
  ),
  Location(name: 'Cairo', place: 'Egypt', imageUrl: 'assets/images/cot.gif'),
];